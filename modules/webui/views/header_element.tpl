  ...
  <div class="navbar-inner">
    ...
    <div class="nav-controll">
      <ul class="nav pull-right">
        ...
        <li><a href="/problems" class="quickinfo" data-original-title='IT Problems'><i class="icon-fullscreen-itproblem"></i><span class="pulsate badger badger-ok">OK!</span> </a></li>
